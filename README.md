# 発表済みの論文（preprint/open access paper）
[山本祐輔](http://hontolab.org/)がこれまで発表した論文のうち、preprintバージョンで公開できるもの（or オープンアクセス論文）を公開します。
...
## 国際会議発表
- Yusuke Yamamoto: ["Scaffolding Inquiry-Oriented Web Search using LLM-based Question Generation"](https://github.com/hontolab/preprint-paper/raw/master/content/JCDL2025.pdf), Proceedings of the 2025 ACM/IEEE Joint Conference on Digital Libraries (JCDL 2025), pp.1-10, Online, December 2025.
- Yusuke Yamamoto: ["Suggestive Answers Strategy in Human-Chatbot Interaction: A Route to Engaged Critical Decision Making"](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2024.1382234/full), Frontiers in Psychology, Vol.15, No.1382234, pp.1-16, March 2024.
...
- Masaki Suzuki and Yusuke Yamamoto: ["Characterizing the Influence of Confirmation Bias on Web Search Behavior"](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2021.771948/full), Frontiers in Psychology, Vol.12, No.771948, pp.1-11, December 2021.
